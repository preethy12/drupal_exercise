...
class FieldWidget extends WidgetBase {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    // Initializes the $element variable with the existing value of $element and
    // adds an array of settings and attributes to it.
    // The + operator is used to merge the arrays.
    $element = $element + [
      '#type' => 'textfield',
